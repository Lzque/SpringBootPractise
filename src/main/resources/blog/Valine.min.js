        ...
        i.prototype.Q = function (e) {
            ...
            var j = function () {
                ...
                var s = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                    ...
                    f = $.hide ? "" : e.cfg.enableQQ && t.get("QQAvatar") ? (0, C.default)('<img class="vimg" src="'+(qq_img)+'" referrerPolicy="no-referrer"/>') : '<img class="vimg" src="' + ($.cdn + (0, u.default)(t.get("mail")) + $.params) + '">',
